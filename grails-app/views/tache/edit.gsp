...
<html>
    ...
    <body>
        <a href="#edit-tache" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <g:if test="${session.user}">
        ...
        <div id="edit-tache" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.tache}" method="PUT">
